...
game_images = {}
framepersecond = 32
pipeimage = 'python.corona/pipe.png'
background_image = 'python.corona/background.jpg'
birdplayer_image = 'python.corona/bird.png'
sealevel_image = 'python.corona/base.jfif'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load('python.corona/0.png').convert_alpha(),
		pygame.image.load('python.corona/1.png').convert_alpha(),
		pygame.image.load('python.corona/2.png').convert_alpha(),
		pygame.image.load('python.corona/3.png').convert_alpha(),
		pygame.image.load('python.corona/4.png').convert_alpha(),
		pygame.image.load('python.corona/5.png').convert_alpha(),
		pygame.image.load('python.corona/6.png').convert_alpha(),
		pygame.image.load('python.corona/7.png').convert_alpha(),
		pygame.image.load('python.corona/8.png').convert_alpha(),
		pygame.image.load('python.corona/9.png').convert_alpha()
	)
